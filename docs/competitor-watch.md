...
| --------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| https://controlresonant.wiki/           | Structured database rows, question-driven internal links, new topic coverage | Its database shows 47 records but cites a July 25 evidence review. Recheck freshness before using any claim.                                                                                                                                              |
| https://controlresonants.wiki/          | Edition comparisons, first-hour reading order, tools, combat questions       | An edition comparison already exists there; a tool alone is not differentiation. Pre-release rankings are not measured meta.                                                                                                                              |
| https://controlresonantgame.wiki/       | Player journey navigation and new category coverage                          | Some categories still contain template copy or no articles. A menu is not content depth.                                                                                                                                                                  |
| https://controlresonant.gamingwiki.net/ | Combat and World topic hubs, Zones and traversal questions                   | Check each exact number and named mechanic against primary sources. Do not copy its article taxonomy wholesale.                                                                                                                                           |
| https://www.controlresonantguide.com/   | Long-form reading structure and emerging player questions                    | Length is not reliability: its combat preview calls The Gap an enemy stagger meter, whereas Remedy describes The Gap as Dylan's build space. It also mixes a five-form taxonomy with the six named early Primary/Secondary choices reported by Xbox Wire. |
...
| Priority     | Player problem                                                  | Best existing destination                                             | Evidence requirement                                                 |
| ------------ | --------------------------------------------------------------- | --------------------------------------------------------------------- | -------------------------------------------------------------------- |
