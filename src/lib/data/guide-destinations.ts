...
export const legacyGuideDestinations: Record<string, string> = {
  ...
  "control-resonant-steam-deck-support": "/game-info#platform-access",
  ...
  "control-resonant-editions-and-pre-order-bonuses": "/game-info#editions",
  "control-resonant-pc-system-requirements": "/game-info#pc-requirements",
  "is-control-resonant-on-game-pass": "/game-info#platform-access",
  "does-control-resonant-use-denuvo": "/game-info#platform-access",
  "is-control-resonant-coming-to-switch-2": "/game-info#platform-access",
