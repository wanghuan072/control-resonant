// Page-level search metadata and editorial update dates. Detail pages keep TDK in their own content data.
export const pageTdk = {
  ...
  "/search": {
    ...
    description:
      "Search CONTROL Resonant guides, buying information and Wiki pages by character, ability, enemy, mission or location to get to the answer you need quickly.",
    updatedAt: "2026-09-18",
  },
  "/wiki/characters": {
